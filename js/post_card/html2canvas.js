/*!
 * html2canvas 1.0.0-rc.13 <https://html2canvas.hertzen.com>
...
! function (A, e) {
  ...
  function w(A, e, t, r, n) {
    ...
    if (-1 !== [p, N, T, O, y].indexOf(c)) return Y;
    if (g(B, e) === v) return Y;
    ...
    if (c === R && -1 !== Z.concat(R, T, D, X, P, x).indexOf(i)) return Y;
    ...
    MA = (yA.prototype.write = function (A) {
      ...
      switch (A) {
        ...
        case 59:
          return vA;
        case 60:
          if (33 === this.peekCodePoint(0) && 45 === this.peekCodePoint(1) && 45 === this.peekCodePoint(2)) return this.consumeCodePoint(), this.consumeCodePoint(), TA;
          break;
        case 64:
      ...
      get SUPPORT_FOREIGNOBJECT_DRAWING() {
        var A = "function" == typeof Array.from && "function" == typeof window.fetch ? function (r) {
          ...
          return B.fillStyle = "red", B.fillRect(0, 0, n, n), ve(t).then(function (A) {
            ...
            return t.style.backgroundImage = "url(" + s + ")", t.style.height = "100px", me(e) ? ve(Le(n, n, 0, 0, t)) : Promise.reject(!1)
          }).then(function (A) {
            return B.drawImage(A, 0, 0), me(B.getImageData(0, 0, n, n).data)
          }).catch(function () {
            return !1
          })
  ...
  var or, ir, ar = {
    ...
    wr = sr("bottom"),
    ur = sr("left");
  (ir = or || (or = {}))[ir.VISIBLE = 0] = "VISIBLE", ir[ir.HIDDEN = 1] = "HIDDEN", ir[ir.SCROLL = 2] = "SCROLL";
  ...
  var lr, Cr, gr, Er, Fr = {
    ...
    fr = Ur("bottom"),
    pr = Ur("left");
  (Er = gr || (gr = {}))[Er.LEFT = 0] = "LEFT", Er[Er.CENTER = 1] = "CENTER";
  var Nr, Kr, Ir = {
    name: "text-align",
    initialValue: "left",
  ...
  (Kr = Nr || (Nr = {}))[Kr.STATIC = 0] = "STATIC", Kr[Kr.RELATIVE = 1] = "RELATIVE", Kr[Kr.ABSOLUTE = 2] = "ABSOLUTE", Kr[Kr.FIXED = 3] = "FIXED";
  var mr, Tr, Rr = {
      name: "position",
      initialValue: "static",
  ...
  (Tr = mr || (mr = {}))[Tr.NONE = 0] = "NONE", Tr[Tr.LOWERCASE = 1] = "LOWERCASE", Tr[Tr.UPPERCASE = 2] = "UPPERCASE";
  var vr, Or, Dr = {
      name: "text-transform",
      initialValue: "none",
  ...
  (Or = vr || (vr = {}))[Or.VISIBLE = 0] = "VISIBLE", Or[Or.HIDDEN = 1] = "HIDDEN";
  var Pr, xr, Vr = {
    name: "visible",
    initialValue: "none",
  ...
  (xr = Pr || (Pr = {})).NORMAL = "normal", xr.BREAK_ALL = "break-all";
  var zr, Xr, Jr = {
      name: "word-break",
      initialValue: "normal",
    ...
    kr = function (A) {
      if (A.type === sA.DIMENSION_TOKEN) switch (A.unit.toLowerCase()) {
        case "s":
          return 1e3 * A.number;
        case "ms":
          return A.number
    ...
    Zr = {
      ...
      type: Ce.LIST,
      parse: function (A) {
        return A.filter(jr).map(function (A) {
          return A.value
        })
      }
    },
  ...
  var nn = {
    ...
    wn = (un.prototype.isVisible = function () {
      return 0 < this.display && 0 < this.opacity && this.visibility === vr.VISIBLE
    }, un.prototype.isTransparent = function () {
      return ee(this.backgroundColor)
    }, un.prototype.isTransformed = function () {
      return null !== this.transform
    }, un.prototype.isPositioned = function () {
      return this.position !== Nr.STATIC
    }, un.prototype.isPositionedWithZIndex = function () {
      return this.isPositioned() && !this.zIndex.auto
    }, un.prototype.isFloating = function () {
      return this.float !== Dt.NONE
    }, un.prototype.isInlineLevel = function () {
      return tn(this.display, 4) || tn(this.display, 33554432) || tn(this.display, 268435456) || tn(this.display, 536870912) || tn(this.display, 67108864) || tn(this.display, 134217728)
    }, un);

  function un(A) {
    this.animationDuration = gn(Qn, A.animationDuration), this.backgroundClip = gn(Te, A.backgroundClip), this.backgroundColor = gn(Re, A.backgroundColor), this.backgroundImage = gn(Qt, A.backgroundImage), this.backgroundOrigin = gn(wt, A.backgroundOrigin), this.backgroundPosition = gn(ut, A.backgroundPosition), this.backgroundRepeat = gn(Ct, A.backgroundRepeat), this.backgroundSize = gn(dt, A.backgroundSize), this.borderTopColor = gn(pt, A.borderTopColor), this.borderRightColor = gn(Nt, A.borderRightColor), this.borderBottomColor = gn(Kt, A.borderBottomColor), this.borderLeftColor = gn(It, A.borderLeftColor), this.borderTopLeftRadius = gn(mt, A.borderTopLeftRadius), this.borderTopRightRadius = gn(Tt, A.borderTopRightRadius), this.borderBottomRightRadius = gn(Rt, A.borderBottomRightRadius), this.borderBottomLeftRadius = gn(Lt, A.borderBottomLeftRadius), this.borderTopStyle = gn(St, A.borderTopStyle), this.borderRightStyle = gn(Mt, A.borderRightStyle), this.borderBottomStyle = gn(yt, A.borderBottomStyle), this.borderLeftStyle = gn(_t, A.borderLeftStyle), this.borderTopWidth = gn(Pt, A.borderTopWidth), this.borderRightWidth = gn(xt, A.borderRightWidth), this.borderBottomWidth = gn(Vt, A.borderBottomWidth), this.borderLeftWidth = gn(zt, A.borderLeftWidth), this.boxShadow = gn(cn, A.boxShadow), this.color = gn(Xt, A.color), this.display = gn(Jt, A.display), this.float = gn(jt, A.cssFloat), this.fontFamily = gn(Zr, A.fontFamily), this.fontSize = gn($r, A.fontSize), this.fontStyle = gn(nn, A.fontStyle), this.fontVariant = gn(en, A.fontVariant), this.fontWeight = gn(An, A.fontWeight), this.letterSpacing = gn($t, A.letterSpacing), this.lineBreak = gn(Ar, A.lineBreak), this.lineHeight = gn(er, A.lineHeight), this.listStyleImage = gn(tr, A.listStyleImage), this.listStylePosition = gn(Br, A.listStylePosition), this.listStyleType = gn(ar, A.listStyleType), this.marginTop = gn(cr, A.marginTop), this.marginRight = gn(Qr, A.marginRight), this.marginBottom = gn(wr, A.marginBottom), this.marginLeft = gn(ur, A.marginLeft), this.opacity = gn(Wr, A.opacity);
    var e = gn(Fr, A.overflow);
    this.overflowX = e[0], this.overflowY = e[1 < e.length ? 1 : 0], this.overflowWrap = gn(hr, A.overflowWrap), this.paddingTop = gn(Hr, A.paddingTop), this.paddingRight = gn(dr, A.paddingRight), this.paddingBottom = gn(fr, A.paddingBottom), this.paddingLeft = gn(pr, A.paddingLeft), this.position = gn(Rr, A.position), this.textAlign = gn(Ir, A.textAlign), this.textDecorationColor = gn(Yr, A.textDecorationColor || A.color), this.textDecorationLine = gn(qr, A.textDecorationLine), this.textShadow = gn(Lr, A.textShadow), this.textTransform = gn(Dr, A.textTransform), this.transform = gn(br, A.transform), this.transformOrigin = gn(_r, A.transformOrigin), this.transitionDuration = gn(Qn, A.transitionDuration), this.visibility = gn(Vr, A.visibility), this.wordBreak = gn(Jr, A.wordBreak), this.zIndex = gn(Gr, A.zIndex)
  }
  var Un, ln = function (A) {
      this.content = gn(Bn, A.content), this.quotes = gn(an, A.quotes)
    },
    Cn = function (A) {
      this.counterIncrement = gn(sn, A.counterIncrement), this.counterReset = gn(on, A.counterReset)
    },
    gn = function (A, e) {
      var t = new MA,
        ...
        case Ce.TYPE_VALUE:
          switch (A.format) {
            ...
            case "length-percentage":
              ...
              return qA(o) ? o : se;
            case "duration":
              return kr(n.parseComponentValue())
          }
      }
      throw new Error("Attempting to parse unsupported css format type " + A.format)
    },
    En = function (A) {
      this.styles = new wn(window.getComputedStyle(A, null)), this.textNodes = [], this.elements = [], null !== this.styles.transform && CB(A) && (A.style.transform = "none");
      var e = this.styles.animationDuration,
        t = this.styles.transitionDuration,
        r = A.style;
      r && (e || t) && (r.animationDuration = "0ms", r.transitionDuration = "0ms"), this.bounds = m(A), this.flags = 0
    },
    Fn = function (A, e) {
    ...
    fn = function (A, e) {
      for (var t, r = function (A, e) {
          ...
          wordBreak: e.overflowWrap === lr.BREAK_WORD ? "break-word" : e.wordBreak
        }), n = []; !(t = r.next()).done;) t.value && n.push(t.value.slice());
      return n
    },
    pn = function (A, e) {
      this.text = Nn(A.data, e.textTransform), this.textBounds = function (A, t, r) {
        var e = dn(A, t),
          n = [],
          B = 0;
        return e.forEach(function (A) {
          if (t.textDecorationLine.length || 0 < A.trim().length)
            if (Oe.SUPPORT_RANGE_BOUNDS) n.push(new Fn(A, Hn(r, B, A.length)));
            else {
              var e = r.splitText(A.length);
              n.push(new Fn(A, hn(r))), r = e
            }
  ...
  var Rn, Ln = (A(vn, Rn = En), vn);

  function vn(A) {
    var e = Rn.call(this, A) || this;
    return e.canvas = A, e.intrinsicWidth = A.width, e.intrinsicHeight = A.height, e
  }
  var On, Dn = (A(bn, On = En), bn);

  function bn(A) {
    for (var e = On.call(this, A) || this, t = A.getElementsByTagName("text"), r = 0; r < t.length; r++) {
      var n = t[r];
      window.getComputedStyle(A, null).getPropertyValue("font-family") && (n.setAttribute("font-family", window.getComputedStyle(A, null).getPropertyValue("font-family")), n.replaceWith(n))
    }
    var B = new XMLSerializer;
    return e.svg = "data:image/svg+xml," + encodeURIComponent(B.serializeToString(A)), e.intrinsicWidth = A.width.baseVal.value, e.intrinsicHeight = A.height.baseVal.value, Se.getInstance().addImage(e.svg), e
  }
  var Sn, Mn = (A(yn, Sn = En), yn);

  function yn(A) {
    var e = Sn.call(this, A) || this;
    return e.value = A.value, e
  }
  var _n, Pn = (A(xn, _n = En), xn);
  ...
  function qn(A) {
    ...
    switch (e.type = A.type.toLowerCase(), e.checked = A.checked, e.value = function (A) {
      ...
      case Jn:
        e.styles.borderTopRightRadius = e.styles.borderTopLeftRadius = e.styles.borderBottomRightRadius = e.styles.borderBottomLeftRadius = zn;
        break;
      case Gn:
  ...
  var nB, BB = (A(sB, nB = En), sB);

  function sB(A) {
    var e = nB.call(this, A) || this;
    ...
    try {
      if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
        e.tree = QB(A.contentWindow.document.documentElement);
        var t = A.contentWindow.document.documentElement ? rB(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor) : He.TRANSPARENT,
          r = A.contentWindow.document.body ? rB(getComputedStyle(A.contentWindow.document.body).backgroundColor) : He.TRANSPARENT;
  ...
  var iB = ["OL", "UL", "MENU"],
    aB = function (A, e, t) {
      for (var r = A.firstChild, n = void 0; r; r = n)
        if (n = r.nextSibling, UB(r) && 0 < r.data.trim().length) e.textNodes.push(new pn(r, e.styles));
        else if (lB(r)) {
        var B = cB(r);
        B.styles.isVisible() && (wB(r, B, t) ? B.flags |= 4 : uB(B.styles) && (B.flags |= 2), -1 !== iB.indexOf(r.tagName) && (B.flags |= 8), e.elements.push(B), NB(r) || hB(r) || KB(r) || aB(r, B, t))
      }
    },
    cB = function (A) {
      return fB(A) ? new mn(A) : dB(A) ? new Ln(A) : hB(A) ? new Dn(A) : gB(A) ? new Mn(A) : EB(A) ? new Pn(A) : FB(A) ? new Yn(A) : KB(A) ? new jn(A) : NB(A) ? new eB(A) : pB(A) ? new BB(A) : new En(A)
    },
    QB = function (A) {
      var e = cB(A);
      return e.flags |= 4, aB(A, e, e), e
    },
    wB = function (A, e, t) {
      return e.styles.isPositionedWithZIndex() || e.styles.opacity < 1 || e.styles.isTransformed() || HB(A) && t.styles.isTransparent()
    },
    uB = function (A) {
    ...
    IB = (mB.prototype.getCounterValue = function (A) {
      var e = this.counters[A];
      return e && e.length ? e[e.length - 1] : 1
    }, mB.prototype.getCounterValues = function (A) {
      var e = this.counters[A];
      return e || []
    }, mB.prototype.pop = function (A) {
      var e = this;
      A.forEach(function (A) {
        return e.counters[A].pop()
      })
    }, mB.prototype.parse = function (A) {
      var t = this,
  ...
  function TB(r, A, e, n, t, B) {
    return r < A || e < r ? xB(r, t, 0 < B.length) : n.integers.reduce(function (A, e, t) {
  ...
  function OB(A, e, t, r, n, B) {
    if (A < -9999 || 9999 < A) return xB(A, rr.CJK_DECIMAL, 0 < n.length);
    var s = Math.abs(A),
      o = n;
    if (0 === s) return e[0] + o;
    for (var i = 0; 0 < s && i <= 4; i++) {
      var a = s % 10;
      0 == a && tn(B, 1) && "" !== o ? o = e[a] + o : 1 < a || 1 == a && 0 === i || 1 == a && 1 === i && tn(B, 2) || 1 == a && 1 === i && tn(B, 4) && 100 < A || 1 == a && 1 < i && tn(B, 8) ? o = e[a] + (0 < i ? t[i - 1] : "") + o : 1 == a && 0 < i && (o = t[i - 1] + o), s = Math.floor(s / 10)
    }
    return (A < 0 ? r : "") + o
  }
  var DB, bB, SB = {
    ...
    xB = function (A, e, t) {
      ...
      switch (e) {
        ...
        case rr.DECIMAL_LEADING_ZERO:
          var o = LB(A, 48, 57, !0, r);
          return o.length < 4 ? "0" + o : o;
        case rr.CJK_DECIMAL:
          return vB(A, "〇一二三四五六七八九", n);
        case rr.LOWER_ROMAN:
          return TB(A, 1, 3999, SB, rr.DECIMAL, r).toLowerCase();
        case rr.UPPER_ROMAN:
          return TB(A, 1, 3999, SB, rr.DECIMAL, r);
        case rr.LOWER_GREEK:
          return LB(A, 945, 969, !1, r);
        case rr.LOWER_ALPHA:
          return LB(A, 97, 122, !1, r);
        case rr.UPPER_ALPHA:
          return LB(A, 65, 90, !1, r);
        case rr.ARABIC_INDIC:
          return LB(A, 1632, 1641, !0, r);
        case rr.ARMENIAN:
        case rr.UPPER_ARMENIAN:
          return TB(A, 1, 9999, MB, rr.DECIMAL, r);
        case rr.LOWER_ARMENIAN:
          return TB(A, 1, 9999, MB, rr.DECIMAL, r).toLowerCase();
        case rr.BENGALI:
          return LB(A, 2534, 2543, !0, r);
        case rr.CAMBODIAN:
        case rr.KHMER:
          return LB(A, 6112, 6121, !0, r);
        case rr.CJK_EARTHLY_BRANCH:
          return vB(A, "子丑寅卯辰巳午未申酉戌亥", n);
        case rr.CJK_HEAVENLY_STEM:
          return vB(A, "甲乙丙丁戊己庚辛壬癸", n);
        case rr.CJK_IDEOGRAPHIC:
        case rr.TRAD_CHINESE_INFORMAL:
          return OB(A, "零一二三四五六七八九", "十百千萬", "負", n, 14);
        case rr.TRAD_CHINESE_FORMAL:
          return OB(A, "零壹貳參肆伍陸柒捌玖", "拾佰仟萬", "負", n, 15);
        case rr.SIMP_CHINESE_INFORMAL:
          return OB(A, "零一二三四五六七八九", "十百千萬", "负", n, 14);
        case rr.SIMP_CHINESE_FORMAL:
          return OB(A, "零壹贰叁肆伍陆柒捌玖", "拾佰仟萬", "负", n, 15);
        case rr.JAPANESE_INFORMAL:
          return OB(A, "〇一二三四五六七八九", "十百千万", "マイナス", n, 0);
        case rr.JAPANESE_FORMAL:
          return OB(A, "零壱弐参四伍六七八九", "拾百千万", "マイナス", n, 7);
        case rr.KOREAN_HANGUL_FORMAL:
          return OB(A, "영일이삼사오육칠팔구", "십백천만", PB, B, 7);
        case rr.KOREAN_HANJA_INFORMAL:
          return OB(A, "零一二三四五六七八九", "十百千萬", PB, B, 0);
        case rr.KOREAN_HANJA_FORMAL:
          return OB(A, "零壹貳參四五六七八九", "拾百千", PB, B, 7);
        case rr.DEVANAGARI:
          return LB(A, 2406, 2415, !0, r);
        case rr.GEORGIAN:
          return TB(A, 1, 19999, _B, rr.DECIMAL, r);
        case rr.GUJARATI:
          return LB(A, 2790, 2799, !0, r);
        case rr.GURMUKHI:
          return LB(A, 2662, 2671, !0, r);
        case rr.HEBREW:
          return TB(A, 1, 10999, yB, rr.DECIMAL, r);
        case rr.HIRAGANA:
          return vB(A, "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわゐゑをん");
        case rr.HIRAGANA_IROHA:
          return vB(A, "いろはにほへとちりぬるをわかよたれそつねならむうゐのおくやまけふこえてあさきゆめみしゑひもせす");
        case rr.KANNADA:
          return LB(A, 3302, 3311, !0, r);
        case rr.KATAKANA:
          return vB(A, "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヰヱヲン", n);
        case rr.KATAKANA_IROHA:
          return vB(A, "イロハニホヘトチリヌルヲワカヨタレソツネナラムウヰノオクヤマケフコエテアサキユメミシヱヒモセス", n);
        case rr.LAO:
          return LB(A, 3792, 3801, !0, r);
        case rr.MONGOLIAN:
          return LB(A, 6160, 6169, !0, r);
        case rr.MYANMAR:
          return LB(A, 4160, 4169, !0, r);
        case rr.ORIYA:
          return LB(A, 2918, 2927, !0, r);
        case rr.PERSIAN:
          return LB(A, 1776, 1785, !0, r);
        case rr.TAMIL:
          return LB(A, 3046, 3055, !0, r);
        case rr.TELUGU:
          return LB(A, 3174, 3183, !0, r);
        case rr.THAI:
          return LB(A, 3664, 3673, !0, r);
        case rr.TIBETAN:
          return LB(A, 3872, 3881, !0, r);
        case rr.DECIMAL:
        default:
          return LB(A, 48, 57, !0, r)
      }
    },
    VB = "data-html2canvas-ignore",
    zB = (XB.prototype.toIFrame = function (A, t) {
      var e = this,
        r = kB(A, t);
      ...
      var n = A.defaultView.pageXOffset,
        ...
        s = r.contentWindow,
        o = s.document,
        i = WB(r).then(function () {
          return a(e, void 0, void 0, function () {
            var e;
            return S(this, function (A) {
              switch (A.label) {
                case 0:
                  return this.scrolledElements.forEach(jB), s && (s.scrollTo(t.left, t.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || s.scrollY === t.top && s.scrollX === t.left || (o.documentElement.style.top = -t.top + "px", o.documentElement.style.left = -t.left + "px", o.documentElement.style.position = "absolute")), e = this.options.onclone, void 0 === this.clonedReferenceElement ? [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")] : o.fonts && o.fonts.ready ? [4, o.fonts.ready] : [3, 2];
                case 1:
                  A.sent(), A.label = 2;
                case 2:
      ...
      return o.open(), o.write(qB(document.doctype) + "<html></html>"), ZB(this.referenceElement.ownerDocument, n, B), o.replaceChild(o.adoptNode(this.documentElement), o.documentElement), o.close(), i
    }, XB.prototype.createElementClone = function (A) {
      return dB(A) ? this.createCanvasClone(A) : oB(A) ? this.createStyleClone(A) : A.cloneNode(!1)
      ...
      if (UB(A)) return document.createTextNode(A.data);
      ...
      if (CB(A) && e) {
        ...
        this.referenceElement === A && (this.clonedReferenceElement = t), HB(t) && ts(t);
        for (var s = this.counters.parse(new Cn(r)), o = this.resolvePseudoContent(A, t, n, DB.BEFORE), i = A.firstChild; i; i = i.nextSibling) lB(i) && ("SCRIPT" === i.tagName || i.hasAttribute(VB) || "function" == typeof this.options.ignoreElements && this.options.ignoreElements(i)) || this.options.copyStyles && lB(i) && oB(i) || t.appendChild(this.cloneNode(i));
        o && t.insertBefore(o, t.firstChild);
        var a = this.resolvePseudoContent(A, t, B, DB.AFTER);
        return a && t.appendChild(a), this.counters.pop(s), r && this.options.copyStyles && !pB(A) && YB(r, t), 0 === A.scrollTop && 0 === A.scrollLeft || this.scrolledElements.push([t, A.scrollLeft, A.scrollTop]), (NB(A) || KB(A)) && (NB(t) || KB(t)) && (t.value = A.value), t
      }
      return A.cloneNode(!1)
      ...
      if (e) {
        ...
        if (C && r && "none" !== r && "-moz-alt-content" !== r && "none" !== e.display) {
          this.counters.parse(new Cn(e));
          var g = new ln(e),
            E = C.createElement("html2canvaspseudoelement");
          YB(e, E), g.content.forEach(function (A) {
            if (A.type === sA.STRING_TOKEN) E.appendChild(C.createTextNode(A.value));
              ...
              if ("attr" === A.name) {
                ...
                if (n && zA(n)) {
                  var s = l.counters.getCounterValue(n.value),
                    o = B && zA(B) ? ar.parse(B.value) : rr.DECIMAL;
                  E.appendChild(C.createTextNode(xB(s, o, !1)))
                }
                ...
                if (B = i[2], n && zA(n)) {
                  var c = l.counters.getCounterValues(n.value),
                    Q = B && zA(B) ? ar.parse(B.value) : rr.DECIMAL,
              ...
              case "open-quote":
                E.appendChild(C.createTextNode(rn(g.quotes, l.quoteDepth++, !0)));
                break;
              case "close-quote":
                E.appendChild(C.createTextNode(rn(g.quotes, --l.quoteDepth, !1)));
                break;
              default:
                E.appendChild(C.createTextNode(A.value))
            }
          }), E.className = $B + " " + As;
          var n = t === DB.BEFORE ? " " + $B : " " + As;
          return function (A) {
  ...
  function XB(A, e) {
    if (this.options = e, this.scrolledElements = [], this.referenceElement = A, this.counters = new IB, this.quoteDepth = 0, !A.ownerDocument) throw new Error("Cloned element does not have an owner document");
    this.documentElement = this.cloneNode(A.ownerDocument.documentElement)
  }(bB = DB || (DB = {}))[bB.BEFORE = 0] = "BEFORE", bB[bB.AFTER = 1] = "AFTER";
  var JB, GB, kB = function (A, e) {
      var t = A.createElement("iframe");
      return t.className = "html2canvas-container", t.style.visibility = "hidden", t.style.position = "fixed", t.style.left = "-10000px", t.style.top = "0px", t.style.border = "0", t.width = e.width.toString(), t.height = e.height.toString(), t.scrolling = "no", t.setAttribute(VB, "true"), A.body.appendChild(t), t
    },
    WB = function (n) {
    ...
    $B = "___html2canvas___pseudoelement_before",
  ...
  (GB = JB || (JB = {}))[GB.VECTOR = 0] = "VECTOR", GB[GB.BEZIER_CURVE = 1] = "BEZIER_CURVE";
  ...
  var Bs = (ss.prototype.add = function (A, e) {
    return new ss(this.x + A, this.y + e)
  }, ss);

  function ss(A, e) {
    this.type = JB.VECTOR, this.x = A, this.y = e
  }

  function os(A, e, t) {
    return new Bs(A.x + (e.x - A.x) * t, A.y + (e.y - A.y) * t)
  }
  var is = (as.prototype.subdivide = function (A, e) {
    var t = os(this.start, this.startControl, A),
      r = os(this.startControl, this.endControl, A),
      n = os(this.endControl, this.end, A),
      B = os(t, r, A),
      s = os(r, n, A),
      o = os(B, s, A);
    return e ? new as(this.start, t, B, o) : new as(o, s, n, this.end)
  }, as.prototype.add = function (A, e) {
    return new as(this.start.add(A, e), this.startControl.add(A, e), this.endControl.add(A, e), this.end.add(A, e))
  }, as.prototype.reverse = function () {
    return new as(this.end, this.endControl, this.startControl, this.start)
  }, as);

  function as(A, e, t, r) {
    this.type = JB.BEZIER_CURVE, this.start = A, this.startControl = e, this.endControl = t, this.end = r
  }

  function cs(A) {
    return A.type === JB.BEZIER_CURVE
  }
  var Qs, ws, us = function (A) {
    var e = A.styles,
      t = A.bounds,
    ...
    var g = t.width - o,
      ...
      m = ae(e.paddingLeft, A.bounds.width);
    this.topLeftBorderBox = 0 < n || 0 < B ? Cs(t.left, t.top, n, B, Qs.TOP_LEFT) : new Bs(t.left, t.top), this.topRightBorderBox = 0 < o || 0 < i ? Cs(t.left + g, t.top, o, i, Qs.TOP_RIGHT) : new Bs(t.left + t.width, t.top), this.bottomRightBorderBox = 0 < c || 0 < Q ? Cs(t.left + F, t.top + E, c, Q, Qs.BOTTOM_RIGHT) : new Bs(t.left + t.width, t.top + t.height), this.bottomLeftBorderBox = 0 < u || 0 < U ? Cs(t.left, t.top + h, u, U, Qs.BOTTOM_LEFT) : new Bs(t.left, t.top + t.height), this.topLeftPaddingBox = 0 < n || 0 < B ? Cs(t.left + p, t.top + H, Math.max(0, n - p), Math.max(0, B - H), Qs.TOP_LEFT) : new Bs(t.left + p, t.top + H), this.topRightPaddingBox = 0 < o || 0 < i ? Cs(t.left + Math.min(g, t.width + p), t.top + H, g > t.width + p ? 0 : o - p, i - H, Qs.TOP_RIGHT) : new Bs(t.left + t.width - d, t.top + H), this.bottomRightPaddingBox = 0 < c || 0 < Q ? Cs(t.left + Math.min(F, t.width - p), t.top + Math.min(E, t.height + H), Math.max(0, c - d), Q - f, Qs.BOTTOM_RIGHT) : new Bs(t.left + t.width - d, t.top + t.height - f), this.bottomLeftPaddingBox = 0 < u || 0 < U ? Cs(t.left + p, t.top + h, Math.max(0, u - p), U - f, Qs.BOTTOM_LEFT) : new Bs(t.left + p, t.top + t.height - f), this.topLeftContentBox = 0 < n || 0 < B ? Cs(t.left + p + m, t.top + H + N, Math.max(0, n - (p + m)), Math.max(0, B - (H + N)), Qs.TOP_LEFT) : new Bs(t.left + p + m, t.top + H + N), this.topRightContentBox = 0 < o || 0 < i ? Cs(t.left + Math.min(g, t.width + p + m), t.top + H + N, g > t.width + p + m ? 0 : o - p + m, i - (H + N), Qs.TOP_RIGHT) : new Bs(t.left + t.width - (d + K), t.top + H + N), this.bottomRightContentBox = 0 < c || 0 < Q ? Cs(t.left + Math.min(F, t.width - (p + m)), t.top + Math.min(E, t.height + H + N), Math.max(0, c - (d + K)), Q - (f + I), Qs.BOTTOM_RIGHT) : new Bs(t.left + t.width - (d + K), t.top + t.height - (f + I)), this.bottomLeftContentBox = 0 < u || 0 < U ? Cs(t.left + p + m, t.top + h, Math.max(0, u - (p + m)), U - (f + I), Qs.BOTTOM_LEFT) : new Bs(t.left + p + m, t.top + t.height - (f + I))
  };
  (ws = Qs || (Qs = {}))[ws.TOP_LEFT = 0] = "TOP_LEFT", ws[ws.TOP_RIGHT = 1] = "TOP_RIGHT", ws[ws.BOTTOM_RIGHT = 2] = "BOTTOM_RIGHT", ws[ws.BOTTOM_LEFT = 3] = "BOTTOM_LEFT";
  ...
  var Cs = function (A, e, t, r, n) {
      ...
      switch (n) {
        case Qs.TOP_LEFT:
          return new is(new Bs(A, a), new Bs(A, a - o), new Bs(i - s, e), new Bs(i, e));
        case Qs.TOP_RIGHT:
          return new is(new Bs(A, e), new Bs(A + s, e), new Bs(i, a - o), new Bs(i, a));
        case Qs.BOTTOM_RIGHT:
          return new is(new Bs(i, e), new Bs(i, e + o), new Bs(A + s, a), new Bs(A, a));
        case Qs.BOTTOM_LEFT:
        default:
          return new is(new Bs(i, a), new Bs(i - s, a), new Bs(A, e + o), new Bs(A, e))
      }
    },
    gs = function (A, e, t) {
    ...
    hs = (Hs.prototype.getParentEffects = function () {
      var A = this.effects.slice(0);
      if (this.container.styles.overflowX !== or.VISIBLE) {
        var e = Us(this.curves),
          t = ls(this.curves);
        ns(e, t) || A.push(new Es(t, 6))
      }
      return A
    }, Hs);

  function Hs(A, e) {
    if (this.container = A, this.effects = e.slice(0), this.curves = new us(A), null !== A.styles.transform) {
      ...
      this.effects.push(new gs(t, r, n))
    }
    if (A.styles.overflowX !== or.VISIBLE) {
      var B = Us(this.curves),
        s = ls(this.curves);
      ns(B, s) ? this.effects.push(new Es(B, 6)) : (this.effects.push(new Es(B, 2)), this.effects.push(new Es(s, 4)))
    }
  }
  ...
  function ps(A, e, t) {
    var r = function (A, e) {
        return 0 === A ? e.bounds : 2 === A ? fs(e) : ds(e)
      }(Ls(A.styles.backgroundOrigin, e), A),
      n = function (A, e) {
        return A === Ee.BORDER_BOX ? e.bounds : A === Ee.CONTENT_BOX ? fs(e) : ds(e)
      }(Ls(A.styles.backgroundClip, e), A),
      B = Rs(Ls(A.styles.backgroundSize, e), t, r),
      s = B[0],
      o = B[1],
      i = jA(Ls(A.styles.backgroundPosition, e), r.width - s, r.height - o);
    return [vs(Ls(A.styles.backgroundRepeat, e), i, B, r, n), Math.round(r.left + i[0]), Math.round(r.top + i[1]), s, o]
  }
  ...
  var Is = function (c, Q, w, u) {
      c.container.elements.forEach(function (A) {
        var e = tn(A.flags, 4),
          t = tn(A.flags, 2),
          r = new hs(A, c.getParentEffects());
        tn(A.styles.display, 2048) && u.push(r);
        var n = tn(A.flags, 8) ? [] : u;
        if (e || t) {
          ...
          Is(r, s, e ? s : w, n)
        } else A.styles.isInlineLevel() ? Q.inlineLevel.push(r) : Q.nonInlineLevel.push(r), Is(r, Q, w, n);
        tn(A.flags, 8) && ms(A, n)
      })
    },
    ms = function (A, e) {
      for (var t = A instanceof Pn ? A.start : 1, r = A instanceof Pn && A.reversed, n = 0; n < e.length; n++) {
        var B = e[n];
        B.container instanceof Mn && "number" == typeof B.container.value && 0 !== B.container.value && (t = B.container.value), B.listValue = xB(t, B.container.styles.listStyleType, !0), t += r ? -1 : 1
      }
    },
    Ts = function (A, e, t, r) {
      var n = [];
      return cs(A) ? n.push(A.subdivide(.5, !1)) : n.push(A), cs(t) ? n.push(t.subdivide(.5, !0)) : n.push(t), cs(r) ? n.push(r.subdivide(.5, !0).reverse()) : n.push(r), cs(e) ? n.push(e.subdivide(.5, !1).reverse()) : n.push(e), n
    },
    Rs = function (A, e, t) {
      var r = e[0],
        n = e[1],
      ...
      var i = Ks(B);
      if (zA(s) && (s.value === Ut.CONTAIN || s.value === Ut.COVER)) return Ks(B) ? t.width / t.height < B != (s.value === Ut.COVER) ? [t.width, t.width / B] : [t.height * B, t.height] : [t.width, t.height];
      var a = Ks(r),
        c = Ks(n),
        Q = a || c;
      if (Ns(s) && (!o || Ns(o))) return a && c ? [r, n] : i || Q ? Q && i ? [a ? r : n * B, c ? n : r / B] : [a ? r : t.width, c ? n : t.height] : [t.width, t.height];
      if (i) {
        var w = 0,
          u = 0;
        return qA(s) ? w = ae(s, t.width) : qA(o) && (u = ae(o, t.height)), Ns(s) ? w = u * B : o && !Ns(o) || (u = w / B), [w, u]
      }
      var U = null,
        l = null;
      if (qA(s) ? U = ae(s, t.width) : o && qA(o) && (l = ae(o, t.height)), null === U || o && !Ns(o) || (l = a && c ? U / r * n : t.height), null !== l && Ns(s) && (U = a && c ? l / n * r : t.width), null !== U && null !== l) return [U, l];
    ...
    vs = function (A, e, t, r, n) {
      ...
      switch (A) {
        case it.REPEAT_X:
          return [new Bs(Math.round(r.left), Math.round(r.top + s)), new Bs(Math.round(r.left + r.width), Math.round(r.top + s)), new Bs(Math.round(r.left + r.width), Math.round(i + r.top + s)), new Bs(Math.round(r.left), Math.round(i + r.top + s))];
        case it.REPEAT_Y:
          return [new Bs(Math.round(r.left + B), Math.round(r.top)), new Bs(Math.round(r.left + B + o), Math.round(r.top)), new Bs(Math.round(r.left + B + o), Math.round(r.height + r.top)), new Bs(Math.round(r.left + B), Math.round(r.height + r.top))];
        case it.NO_REPEAT:
          return [new Bs(Math.round(r.left + B), Math.round(r.top + s)), new Bs(Math.round(r.left + B + o), Math.round(r.top + s)), new Bs(Math.round(r.left + B + o), Math.round(r.top + s + i)), new Bs(Math.round(r.left + B), Math.round(r.top + s + i))];
        default:
          return [new Bs(Math.round(n.left), Math.round(n.top)), new Bs(Math.round(n.left + n.width), Math.round(n.top)), new Bs(Math.round(n.left + n.width), Math.round(n.height + n.top)), new Bs(Math.round(n.left), Math.round(n.height + n.top))]
      }
    },
    Os = "Hidden Text",
    Ds = (bs.prototype.parseMetrics = function (A, e) {
      var t = this._document.createElement("div"),
        r = this._document.createElement("img"),
        n = this._document.createElement("span"),
        B = this._document.body;
      t.style.visibility = "hidden", t.style.fontFamily = A, t.style.fontSize = e, t.style.margin = "0", t.style.padding = "0", B.appendChild(t), r.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", r.width = 1, r.height = 1, r.style.margin = "0", r.style.padding = "0", r.style.verticalAlign = "baseline", n.style.fontFamily = A, n.style.fontSize = e, n.style.margin = "0", n.style.padding = "0", n.appendChild(this._document.createTextNode(Os)), t.appendChild(n), t.appendChild(r);
      var s = r.offsetTop - n.offsetTop + 2;
      t.removeChild(n), t.appendChild(this._document.createTextNode(Os)), t.style.lineHeight = "normal", r.style.verticalAlign = "super";
      var o = r.offsetTop - t.offsetTop + 2;
      return B.removeChild(t), {
        baseline: s,
        middle: o
      }
    }, bs.prototype.getMetrics = function (A, e) {
      var t = A + " " + e;
  ...
  var Ss = (Ms.prototype.applyEffects = function (A, e) {
    for (var t = this; this._activeEffects.length;) this.popEffect();
    A.filter(function (A) {
      return tn(A.target, e)
    }).forEach(function (A) {
      return t.applyEffect(A)
    })
  }, Ms.prototype.applyEffect = function (A) {
    this.ctx.save(),
      function (A) {
        return 0 === A.type
  ...
  }, Ms.prototype.popEffect = function () {
    this._activeEffects.pop(), this.ctx.restore()
  }, Ms.prototype.renderStack = function (t) {
    return a(this, void 0, void 0, function () {
      var e;
      return S(this, function (A) {
        switch (A.label) {
  ...
  }, Ms.prototype.renderNode = function (e) {
    return a(this, void 0, void 0, function () {
      return S(this, function (A) {
        switch (A.label) {
          case 0:
  ...
  }, Ms.prototype.renderTextWithLetterSpacing = function (A, t, e) {
    var r = this;
    if (void 0 === e) this.ctx.fillText(A.text, A.bounds.left, A.bounds.top + A.bounds.height);
    else
      for (var n = c(A.text).map(function (A) {
          return l(A)
        }), B = function (r, A, e) {
          for (var t = [], n = 0, B = "", s = 0, o = 0; o < r.length; o++)
            if ("\n" === r[o]) t.push([-1, n]), n++, Q(0, 0);
            else {
              B += r[o];
              var i = e(B, ++s);
              if (t.push([i - e(r[o], 1), n]), A < i)
                if (" " === r[o]) {
                  for (var a = o; 0 < a && t[a][1] === n && " " === r[a];) a--;
                  for (var c = o; a < c; c--) t[c][0] = -1;
                  for (n++, Q(0, 0); o < r.length + 1 && " " === r[o + 1];) t.push([-1, n]), o++
                } else if ("-" === r[o]) n++, Q(o, o + 1), t[o] = [0, n];
              else {
                for (a = o; 0 < a && t[a][1] === n && " " !== r[a] && "-" !== r[a];) a--;
                if (n++, " " === r[a] || "-" === r[a]) {
                  for (Q(a + 1, o + 1), c = o; a < c; c--) t[c] = [t[c][0] - t[a + 1][0], n];
                  " " === r[a] && (t[a][0] = -1)
                } else Q(o, o + 1), t[o] = [0, n]
              }
            } return t;

          function Q(A, e) {
            B = "";
            for (var t = A; t < e; t++) B += r[t];
            s = e - A
          }
        }(n, A.bounds.width, function (A, e) {
          return r.ctx.measureText(A).width + t * (e - 1)
        }), s = A.bounds.left, o = A.bounds.top + e / 2, i = 0; i < B.length; i++) 0 <= B[i][0] && this.ctx.fillText(n[i], B[i][0] + s, B[i][1] * e + o)
  }, Ms.prototype.createFontStyle = function (A) {
  ...
  }, Ms.prototype.renderTextNode = function (r, o) {
    return a(this, void 0, void 0, function () {
      var e, t, n, B, s = this;
      return S(this, function (A) {
  ...
  }, Ms.prototype.renderReplacedElement = function (A, e, t) {
  ...
  }, Ms.prototype.renderNodeContent = function (C) {
    return a(this, void 0, void 0, function () {
      var e, t, r, n, B, s, o, i, a, c, Q, w, u, U, l;
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            this.applyEffects(C.effects, 4), e = C.container, t = C.curves, r = e.styles, n = 0, B = e.textNodes, A.label = 1;
          case 1:
          ...
          case 14:
            if (e instanceof Yn && (i = Math.min(e.bounds.width, e.bounds.height), e.type === Jn ? e.checked && (this.ctx.save(), this.path([new Bs(e.bounds.left + .39363 * i, e.bounds.top + .79 * i), new Bs(e.bounds.left + .16 * i, e.bounds.top + .5549 * i), new Bs(e.bounds.left + .27347 * i, e.bounds.top + .44071 * i), new Bs(e.bounds.left + .39694 * i, e.bounds.top + .5649 * i), new Bs(e.bounds.left + .72983 * i, e.bounds.top + .23 * i), new Bs(e.bounds.left + .84 * i, e.bounds.top + .34085 * i), new Bs(e.bounds.left + .39363 * i, e.bounds.top + .79 * i)]), this.ctx.fillStyle = te(Wn), this.ctx.fill(), this.ctx.restore()) : e.type === Gn && e.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(e.bounds.left + i / 2, e.bounds.top + i / 2, i / 4, 0, 2 * Math.PI, !0), this.ctx.fillStyle = te(Wn), this.ctx.fill(), this.ctx.restore())), ys(e) && e.value.length) {
              switch (this.ctx.font = this.createFontStyle(r)[0], this.ctx.fillStyle = te(r.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = Ps(e.styles.textAlign), l = fs(e), a = 0, e.styles.textAlign) {
                case gr.CENTER:
                  a += l.width / 2;
                  break;
                case gr.RIGHT:
              ...
              c = l.add(a, 0, 0, -l.height / 2 + 1), this.ctx.save(), this.path([new Bs(l.left, l.top), new Bs(l.left + l.width, l.top), new Bs(l.left + l.width, l.top + l.height), new Bs(l.left, l.top + l.height)]), this.ctx.clip(), Q = e instanceof eB ? kt(r.lineHeight, r.fontSize.number) : void 0, this.renderTextWithLetterSpacing(new Fn(e.value, c), r.letterSpacing, Q), this.ctx.restore(), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"
            }
            if (!tn(e.styles.display, 2048)) return [3, 20];
            if (null === e.styles.listStyleImage) return [3, 19];
            if ((w = e.styles.listStyleImage).type !== xe.URL) return [3, 18];
            u = void 0, U = w.url, A.label = 15;
          case 15:
            return A.trys.push([15, 17, , 18]), [4, this.options.cache.match(U)];
          case 16:
            return u = A.sent(), this.ctx.drawImage(u, e.bounds.left - (u.width + 10), e.bounds.top), [3, 18];
          case 17:
            return A.sent(), De.getInstance(this.options.id).error("Error loading list-style-image " + U), [3, 18];
          case 18:
            return [3, 20];
          case 19:
            C.listValue && e.styles.listStyleType !== rr.NONE && (this.ctx.font = this.createFontStyle(r)[0], this.ctx.fillStyle = te(r.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = "right", l = new I(e.bounds.left, e.bounds.top + ae(e.styles.paddingTop, e.bounds.width), e.bounds.width, kt(r.lineHeight, r.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new Fn(C.listValue, l), r.letterSpacing), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"), A.label = 20;
          case 20:
            return [2]
        }
      })
    })
  }, Ms.prototype.renderStackContent = function (C) {
    return a(this, void 0, void 0, function () {
      var e, t, r, n, B, s, o, i, a, c, Q, w, u, U, l;
      return S(this, function (A) {
        switch (A.label) {
  ...
  }, Ms.prototype.path = function (A) {
    this.ctx.beginPath(), this.formatPath(A), this.ctx.closePath()
  }, Ms.prototype.formatPath = function (A) {
    var r = this;
    A.forEach(function (A, e) {
      var t = cs(A) ? A.start : A;
      0 === e ? r.ctx.moveTo(t.x, t.y) : r.ctx.lineTo(t.x, t.y), cs(A) && r.ctx.bezierCurveTo(A.startControl.x, A.startControl.y, A.endControl.x, A.endControl.y, A.end.x, A.end.y)
    })
  }, Ms.prototype.renderRepeat = function (A, e, t, r) {
    this.path(A), this.ctx.fillStyle = e, this.ctx.translate(t, r), this.ctx.fill(), this.ctx.translate(-t, -r)
  }, Ms.prototype.resizeImage = function (A, e, t) {
  ...
  }, Ms.prototype.renderBackgroundImage = function (b) {
    return a(this, void 0, void 0, function () {
      var O, e, D, t, r, n;
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            O = b.styles.backgroundImage.length - 1, e = function (e) {
              var t, r, n, B, s, o, i, a, c, Q, w, u, U, l, C, g, E, F, h, H, d, f, p, N, K, I, m, T, R, L, v;
              return S(this, function (A) {
                switch (A.label) {
                  case 0:
                  ...
                  case 4:
                    return t && (n = ps(b, O, [t.width, t.height, t.width / t.height]), g = n[0], f = n[1], p = n[2], h = n[3], H = n[4], l = D.ctx.createPattern(D.resizeImage(t, h, H), "repeat"), D.renderRepeat(g, l, f, p)), [3, 6];
                  case 5:
                    ! function (A) {
                      return A.type === xe.LINEAR_GRADIENT
                    }(e) ? function (A) {
                      return A.type === xe.RADIAL_GRADIENT
                    }(e) && (C = ps(b, O, [null, null, null]), g = C[0], E = C[1], F = C[2], h = C[3], H = C[4], d = 0 === e.position.length ? [oe] : e.position, f = ae(d[0], h), p = ae(d[d.length - 1], H), N = function (A, e, t, r, n) {
                      var B = 0,
                        s = 0;
                      switch (A.size) {
                    ...
                    }(e, f, p, h, H), K = N[0], I = N[1], 0 < K && 0 < K && (m = D.ctx.createRadialGradient(E + f, F + p, 0, E + f, F + p, K), fe(e.stops, 2 * K).forEach(function (A) {
                      return m.addColorStop(A.stop, te(A.color))
                    }), D.path(g), D.ctx.fillStyle = m, K !== I ? (T = b.bounds.left + .5 * b.bounds.width, R = b.bounds.top + .5 * b.bounds.height, v = 1 / (L = I / K), D.ctx.save(), D.ctx.translate(T, R), D.ctx.transform(1, 0, 0, L, 0, 0), D.ctx.translate(-T, -R), D.ctx.fillRect(E, v * (F - R) + R, h, H * v), D.ctx.restore()) : D.ctx.fill())) : (B = ps(b, O, [null, null, null]), g = B[0], f = B[1], p = B[2], h = B[3], H = B[4], s = pe(e.angle, h, H), o = s[0], i = s[1], a = s[2], c = s[3], Q = s[4], (w = document.createElement("canvas")).width = h, w.height = H, u = w.getContext("2d"), U = u.createLinearGradient(i, c, a, Q), fe(e.stops, o).forEach(function (A) {
  ...
  }, Ms.prototype.renderBorder = function (e, t, r) {
    return a(this, void 0, void 0, function () {
      return S(this, function (A) {
        return this.path(function (A, e) {
          switch (e) {
            case 0:
              return Ts(A.topLeftBorderBox, A.topLeftPaddingBox, A.topRightBorderBox, A.topRightPaddingBox);
            case 1:
              return Ts(A.topRightBorderBox, A.topRightPaddingBox, A.bottomRightBorderBox, A.bottomRightPaddingBox);
            case 2:
              return Ts(A.bottomRightBorderBox, A.bottomRightPaddingBox, A.bottomLeftBorderBox, A.bottomLeftPaddingBox);
            case 3:
            default:
              return Ts(A.bottomLeftBorderBox, A.bottomLeftPaddingBox, A.topLeftBorderBox, A.topLeftPaddingBox)
          }
        }(r, t)), this.ctx.fillStyle = te(e), this.ctx.fill(), [2]
      })
    })
  }, Ms.prototype.renderNodeBackgroundAndBorders = function (c) {
    return a(this, void 0, void 0, function () {
      ...
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            ...
            }], n = _s(Ls(e.backgroundClip, 0), c.curves), t || e.boxShadow.length ? (this.ctx.save(), this.path(n), this.ctx.clip(), ee(e.backgroundColor) || (this.ctx.fillStyle = te(e.backgroundColor), this.ctx.fill()), [4, this.renderBackgroundImage(c.container)]) : [3, 2];
          case 1:
  ...
  }, Ms.prototype.render = function (t) {
    return a(this, void 0, void 0, function () {
      var e;
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            return this.options.backgroundColor && (this.ctx.fillStyle = te(this.options.backgroundColor), this.ctx.fillRect(this.options.x - this.options.scrollX, this.options.y - this.options.scrollY, this.options.width, this.options.height)), e = function (A) {
              var e = new hs(A, []),
                t = new Fs(e),
                r = [];
              return Is(e, t, t, r), ms(e.container, r), t
  ...
  function Ms(A) {
    this._activeEffects = [], this.canvas = A.canvas ? A.canvas : document.createElement("canvas"), this.ctx = this.canvas.getContext("2d"), (this.options = A).canvas || (this.canvas.width = Math.floor(A.width * A.scale), this.canvas.height = Math.floor(A.height * A.scale), this.canvas.style.width = A.width + "px", this.canvas.style.height = A.height + "px"), this.fontMetrics = new Ds(document), this.ctx.scale(this.options.scale, this.options.scale), this.ctx.translate(-A.x + A.scrollX, -A.y + A.scrollY), this.ctx.textBaseline = "bottom", this._activeEffects = [], De.getInstance(A.id).debug("Canvas renderer initialized (" + A.width + "x" + A.height + " at " + A.x + "," + A.y + ") with scale " + A.scale)
  }
  var ys = function (A) {
      return A instanceof eB || (A instanceof jn || A instanceof Yn && A.type !== Gn && A.type !== Jn)
    },
    _s = function (A, e) {
      switch (A) {
        case Ee.BORDER_BOX:
    ...
    xs = (Vs.prototype.render = function (r) {
      return a(this, void 0, void 0, function () {
        var e, t;
        return S(this, function (A) {
          switch (A.label) {
      ...
      return S(this, function (A) {
        switch (A.label) {
          case 0:
            ...
            return r = (Math.round(1e3 * Math.random()) + Date.now()).toString(16), n = HB(p) || function (A) {
            ...
            }(e) : m(p), B = n.width, s = n.height, o = n.left, i = n.top, a = K({}, {
              allowTaint: !1,
              imageTimeout: 15e3,
              proxy: void 0,
              useCORS: !1
              ...
              id: r,
              enabled: Q.logging
            }), De.getInstance(r).debug("Starting document clone"), u = new zB(p, {
              id: r,
              onclone: Q.onclone,
          ...
          case 1:
            return l = A.sent(), C = e.documentElement ? zs(getComputedStyle(e.documentElement).backgroundColor) : He.TRANSPARENT, g = e.body ? zs(getComputedStyle(e.body).backgroundColor) : He.TRANSPARENT, E = N.backgroundColor, F = "string" == typeof E ? zs(E) : null === E ? He.TRANSPARENT : 4294967295, h = p === e.documentElement ? ee(C) ? ee(g) ? F : g : C : F, H = {
              id: r,
              cache: Q.cache,
              canvas: Q.canvas,
              backgroundColor: h,
            ...
            }, Q.foreignObjectRendering ? (De.getInstance(r).debug("Document cloned, using foreign object rendering"), [4, new xs(H).render(U)]) : [3, 3];
          case 2:
            return d = A.sent(), [3, 5];
          case 3:
            return De.getInstance(r).debug("Document cloned, using computed rendering"), Se.attachInstance(Q.cache), De.getInstance(r).debug("Starting DOM parsing"), f = QB(U), Se.detachInstance(), h === f.styles.backgroundColor && (f.styles.backgroundColor = He.TRANSPARENT), De.getInstance(r).debug("Starting renderer"), [4, new Ss(H).render(f)];
          case 4:
            d = A.sent(), A.label = 5;
          case 5:
            return !0 === Q.removeContainer && (zB.destroy(l) || De.getInstance(r).error("Cannot detach cloned iframe as it is not in the DOM anymore")), De.getInstance(r).debug("Finished rendering"), De.destroy(r), Se.destroy(r), [2, d]
        }
      })
    })
  };
  return function (A, e) {
    return void 0 === e && (e = {}), Js(A, e)
  }
});